...
export default function HomePage({ setCart, cart }) {
  ...
  if (productsList === undefined) {
    ...
    const cocktailFiltered = productsList.filter(
      (product) => product.category === "cocktail"
    );
    //console.log(cocktailFiltered);

    const copyrightFiltered = productsList.filter(
      (product) => product.category === "copyright"
    );
    //console.log(copyrightFiltered);

    const beerFiltered = productsList.filter(
      (product) => product.category === "beer"
    );
    //console.log(copyrightFiltered);

    const shotFiltered = productsList.filter(
      (product) => product.category === "shot"
    );
    //console.log(shotFiltered);

    const whiskeyFiltered = productsList.filter(
      (product) => product.category === "whiskey"
    );
    //console.log(whiskeyFiltered);

    const wineFiltered = productsList.filter(
      (product) => product.category === "wine"
    );
    //console.log(wineFiltered);

    const bottleFiltered = productsList.filter(
      (product) => product.category === "bottle"
    );
    //console.log(bottleFiltered);

    const noalcoholFiltered = productsList.filter(
      (product) => product.category === "noalcohol"
    );
      ...
      <>
        ...
        <MainContainer>
          <TopContainer>
            ...
            <img
              src={capaHome}
              alt="imagem capa diversas garrafas de bebidas"
            />
          </TopContainer>
